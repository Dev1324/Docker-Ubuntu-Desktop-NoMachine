...
clear
echo "Repo: https://github.com/Dev1324/Docker-Ubuntu-Desktop-NoMachine"
echo "======================="
...
seq 1 2600000 | while read i; do echo -en "\r Running .     $i s /2600000 s"; sleep 0.1;echo -en "\r Running ..    $i s /2600000 s"; sleep 0.1;echo -en "\r Running ...   $i s /2600000 s"; sleep 0.1;echo -en "\r Running ....  $i s /2600000 s"; sleep 0.1;echo -en "\r Running ..... $i s /2600000 s"; sleep 0.1;echo -en "\r Running     . $i s /2600000 s"; sleep 0.1;echo -en "\r Running  .... $i s /2600000 s"; sleep 0.1;echo -en "\r Running   ... $i s /2600000 s"; sleep 0.1;echo -en "\r Running    .. $i s /2600000 s"; sleep 0.1;echo -en "\r Running     . $i s /2600000 s"; sleep 0.1;done
